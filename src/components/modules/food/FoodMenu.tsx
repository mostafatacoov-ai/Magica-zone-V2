...
import { Utensils, Flame, CheckCircle2, ArrowRight, ArrowLeft } from 'lucide-react';
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                                ...
                                <button
                                    type="button"
                                    className={`px-4 py-2 rounded-xl text-xs font-bold transition-colors ${isSelected ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                        }`}
                                >
                                    {isSelected ? (isAr ? 'القائمة المختارة للحساب' : 'Selected') : (isAr ? 'اختيار القائمة' : 'Select Menu')}
                                </button>
                            </div>
                        </div>
                    );
