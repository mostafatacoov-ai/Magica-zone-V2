...
export function AdminNav({ lang }: { lang: string }) {
  ...
  const tabs = [
    ...
    { href: `/${lang}/admin/supplies`, label: isAr ? 'المستلزمات' : 'Supplies', icon: Backpack },
    { href: `/${lang}/admin/uniform`, label: isAr ? 'اليونيفورم' : 'Uniforms', icon: Shirt },
    { href: `/${lang}/admin/bazar`, label: isAr ? 'البازار' : 'Bazar Store', icon: ShoppingBag },
  ...
  return (
    <div className="flex items-center justify-between gap-2 border-b border-gray-200 pb-2 overflow-x-auto">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-bold text-red-600 hover:bg-red-50 rounded-xl transition-colors border border-red-200 shrink-0"
        title="Log Out Admin"
      >
